...
class DataVisualizer:
    ...
    # ================================================================== #
    # РЭГРЭСІЙНЫЯ ГРАФІКІ (PageValues) — выкарыстаны ў RegressorBench,
    # RegressionEvaluator і TwoStageRegressor (гл. regression_analysis_report.docx)
    # ================================================================== #
    ...
    def plot_zero_prediction_diagnostic(
        ...
        *,
        ...
        zero-inflated таргеце (гл. Мал. 4 у справаздачы, TwoStageRegressor).
        """
        y_true = np.asarray(y_true)
        zero_mask = y_true == 0
